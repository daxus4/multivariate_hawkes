...
DATA_FOLDER = "data"
ORDERBOOK_CHANGES_FOLDER = "C:\\Users\\Admin\\OneDrive - Politecnico di Milano\\phd\\dati\\hawkes\\orderbook_changes"
...
COE_TRAINING_DATAFRAMES_FOLDER = os.path.join(
    COE_DATAFRAMES_FOLDER, "training_dataframes"
)
COE_SIMULATION_DATAFRAMES_FOLDER = os.path.join(
    COE_DATAFRAMES_FOLDER, "simulation_dataframes"
)
...
SIMULATION_START_TIMESTAMPS_FILE = "start_simulations_sequential_first50.csv"
