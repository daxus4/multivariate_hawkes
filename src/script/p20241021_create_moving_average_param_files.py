...
for pair in pairs:
    for window_duration_second in window_duration_seconds:
        ...
        params_path = (
            "C:\\Users\\Admin\\OneDrive - Politecnico di Milano\\phd\\code\\multivariate_hawkes\\data\\trained_params\\moving_average\\"
            + pair
        ...
        for index, row in df.iterrows():
            ...
            param_file = os.path.join(
                params_path,
                f"{base_file_name}_{timestamp_sim}_window_duration_seconds.txt",
            )
