...
for pair in pairs:
    for training_time in training_times:
        ...
        params_path = (
            "C:\\Users\\Admin\\OneDrive - Politecnico di Milano\\phd\\code\\multivariate_hawkes\\data\\trained_params\\poisson\\"
            + pair
            + f"\\training_time_{training_time}\\"
        )
        ...
        for index, row in df.iterrows():
            ...
            start_time = timestamp_sim - training_time
