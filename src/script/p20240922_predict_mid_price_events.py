    ...
    for row in run_info_db.itertuples(index=False):
        ...
        testing_conf_map = get_conf(
            os.path.join(
                ...
                run_info.testing_conf_filename
            )
        )
        ...
        for loading_info in loading_info_for_all_dfs:
            ...
            for start_simulation_time in loading_info.start_times:
                start_warmup_time = start_simulation_time - testing_conf.seconds_warm_up_period
                end_simulation_time = start_simulation_time + testing_conf.seconds_simulation_period
